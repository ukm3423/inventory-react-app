...
function ViewDetails() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8082/masterservice/api/reports/get-purchase-report/${purchaseId}`)
            .then(response => {
    ...
    if (!purchaseDetails) {
        return <div className="container mx-auto p-6 bg-white rounded-lg shadow-md">No details available.</div>;
    }

    const { invoiceNo, deliveryDate, orderNo, orderDate, supplier, amount, purchaseDetailsList } = purchaseDetails;
        ...
        <div className="p-4 m-6 bg-white rounded-lg shadow-md">
            <div className="grid grid-cols-1 mt-4 lg:grid-cols-1 gap-6">
                <div id="printSection">
                    ...
                    <h3 className="text-2xl mt-8 font-semibold text-gray-800 mb-4">Product List :-</h3>
