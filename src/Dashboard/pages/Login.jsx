...
import {
  ...
  RotateLoader,
  ScaleLoader,
} from "react-spinners"; // Import a premium spinner
import axios from "axios";
import background from "../assets/iStock-1024926532.webp";
function AdminLogin() {
  const API = "http://192.168.1.157:8081/authservice/api";
      ...
      <div className="md:mt-0 max-w-md w-full space-y-8 p-6 sm:p-8 bg-white bg-opacity-95 rounded-lg shadow-lg border border-gray-500 relative z-10">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <a
              href="/"
              className="w-full flex items-center justify-center px-3 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
            >
              <img
                className="h-5 w-5"
