...
export default function Category() {
  const perPage = 10;
  const API = `http://192.168.1.157:8082/masterservice/api/category`;
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.success(
        courseStatusToDelete ? "Category Deactivated." : "Category Activated."
      );
    } catch (error) {
                  ...
                  >
                    ...
                    <td className="px-6 py-2 text-gray-800 whitespace-nowrap">
                      <div className="flex space-x-4">
                        ...
                        <button
                          onClick={() =>
                            handleDeleteConfirmation(course.id, course.status)
                          }
