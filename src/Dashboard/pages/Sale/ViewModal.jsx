...
const ViewModal = ({ sale, onClose }) => {
    ...
    function calculateGrandTotal() {
        ...
        // Format grandTotal as Indian currency (Rupees)
                        ...
                        <div className="overflow-x-auto">
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    ...
                                    {/* Grand Total Row */}
                                    <tr className="">
                                        <td colSpan="5" className="px-6 py-3 text-right text-sm font-medium text-gray-500 uppercase tracking-wider">Grand Total :-</td>
                                        <td className="px-6 py-3 text-gray-800 font-semibold">{calculateGrandTotal()}</td>
                                    </tr>
                                </tbody>
